<x-app-layout>
                ...
                <div class="grid grid-cols-5 items-center">
                    <div class="col-span-2 mb-4 h-32 w-32">
                        <div id="member_image" class="border border-gray-600 rounded-lg h-32 w-32">
                            <img src="" width="350" height="350" id="image_display" class="h-32 w-32 rounded-lg p-2" style="display:none;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            CreditInput.addEventListener('input', updateCurrentBalance);
    
            function updateCurrentBalance() {
                const balance = parseFloat(balanceInput.value) || 0;
                const Credit = parseFloat(CreditInput.value) || 0;
                currentBalance.value = (balance - Credit).toFixed(2);
            }
