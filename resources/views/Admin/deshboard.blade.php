<x-app-layout>
    <div class="lg:grid grid-cols-10">
        ...
        <div class="col-span-8">
                ...
                <div class="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div class="p-4 space-x-4 rounded-lg md:space-x-6 bg-slate-300 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
                        <div class="text-center">
                            <p class="text-3xl font-semibold leading-none">{{ \App\Models\User::count() }}</p>
                            <p class="capitalize">Total User</p>
                        </div>
                    </div>
                    <div class="p-4 space-x-4 rounded-lg md:space-x-6 bg-slate-300 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
                        <div class="text-center">
                            <p class="text-3xl font-semibold leading-none">{{ \App\Models\Member::count() }}</p>
                            <p class="capitalize">Total Member</p>
                        </div>
                    </div>
                    ...
                    <div class="p-4 space-x-4 bg-slate-300 rounded-lg md:space-x-6 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
                        ...
                        <div class="flex flex-col items-center justify-center align-middle">
                            <p class="text-3xl font-semibold leading-none">{{ \App\Models\BankInfo::count() }}</p>
                            <p class="capitalize">Total Bank Account</p>
                        </div>
                    </div>
                    <div class="p-4 space-x-4 bg-slate-300 rounded-lg md:space-x-6 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
                        
                        <div class="flex flex-col items-center justify-center align-middle">
                            <p class="text-3xl font-semibold leading-none">{{ \App\Models\BankTransactionProfile::count() }}</p>
                            <p class="capitalize">Total Bank Transection</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="lg:flex mt-10 w-full space-x-4 my-6">
                <!-- Chart section -->
                ...
                <div class="flex-1 mr-5">
                    ...
                    @else
                        <table class=" bg-white dark:bg-gray-900 rounded-lg shadow-md">
                            <thead>
