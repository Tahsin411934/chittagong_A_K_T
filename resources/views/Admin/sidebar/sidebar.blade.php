<div
    class=" fixed flex-col h-screen hidden lg:flex p-3 w-60  bg-transparent border-r dark:border-gray-700 dark:text-white font-inter text-[#0a0a0a] shadow-2xl ">
    <div class="space-y-3">
        ...
        <div class="relative mb-4 ">
            <form action="/search" method="GET" class="relative">
                ...
                <input type="search" id="searchInput" placeholder="Search..."
                    class=" w-[98%] py-2 pl-10 text-sm border rounded-md focus:outline-none dark:bg-gray-100 dark:text-gray-800 focus:dark:bg-gray-50">
            </form>
        </div>
