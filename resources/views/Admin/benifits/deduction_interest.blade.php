            ...
            <div class="shadow-2xl p-8 border">
                <div>
                    <div class="container mx-auto p-6">
                        <h2 class="text-2xl font-semibold mb-6">Deduction Bank Interest</h2>

                        <form action="{{ route('bank.transaction.store') }}" method="POST" class="space-y-4">
                            @csrf
                            <div>
                                <label for="bank_acc_id" class="block text-sm font-medium text-gray-100">Bank Name</label>
                            ...
                            <div class="hidden">
                                ...
                                <input type="text" name="cause" id="cause" value="Interest Deducted"
                                    class="w-full dark:bg-slate-700 p-2 border border-gray-300 rounded" required>
                            </div>
