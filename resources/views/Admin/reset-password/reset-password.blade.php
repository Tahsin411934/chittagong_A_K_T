                    ...
                    <div class="space-y-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input list="usernames" id="UserName" name="UserName" value="{{ old('UserName') }}"
                                class="form-input mt-1 block w-full px-4 py-2 rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" id="old_password" name="old_password"
                                ...
                                class="form-input mt-1 block w-full px-4 py-2 rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                required>
                            @error('old_password') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        <!-- New Password Field -->
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" id="NewPassword_confirmation" name="NewPassword_confirmation"
                                ...
                                class="form-input mt-1 block w-full px-4 py-2 rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                required>
                            @error('NewPassword_confirmation') <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
